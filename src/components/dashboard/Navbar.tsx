...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border shadow-lg">
      <div className="mx-auto max-w-7xl flex items-center justify-between px-4 py-3">
        ...
        <div className="hidden sm:flex items-center gap-3">
          {/* ROLE SWITCH */}
          <div className="flex rounded-xl border border-border bg-card backdrop-blur overflow-hidden">
          ...
          <button
            ...
            className="relative h-10 w-10 flex items-center justify-center rounded-xl border border-border bg-card transition-all hover:scale-110 group"
          >
            {isDark ? (
        ...
        <button
          ...
          className="sm:hidden h-10 w-10 flex items-center justify-center rounded-xl border border-border bg-card"
        >
          {menuOpen ? <X /> : <Menu />}
        </button>
      </div>
      ...
      >
        <div className="p-4 space-y-3 bg-background border-t border-border">
          ...
          <button
            onClick={onToggleDark}
            className="w-full py-2 rounded-xl border border-border text-foreground"
          >
            Toggle Theme
          </button>
        </div>
